<template>
    <Modal @closeModal="closeModal" :isVisible="showModal">
        ...
        <p class="font18">
            Are you sure you want to delete your comment?<br><strong><u>This cannot be undone.</u></strong> You will <strong><u>lose any cups of tea</u></strong> gained from this comment.
        </p>
