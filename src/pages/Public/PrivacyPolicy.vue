<template>
    <Blog class="terms">
        <Banner title="Privacy Policy" firstMessage="Welcome to BetaMe!"  secondMessage="Please read through our privacy policy before joining our community." />
        <br>
        <div class="row">
            <div class="col-2">
                <a class="beta-link" href="#" v-scroll-to="{
                        el: '#principles',
                        duration: 500,
                        easing: 'linear',
                        offset: -100,
...
<h3 class="beta-title">Who We Are and What This Policy Covers</h3>
...
<ul>
<li>Our websites (including automattic.com, wordpress.com, vip.wordpress.com, jetpack.com, woocommerce.com, crowdsignal.com, gravatar.com, intensedebate.com, vaultpress.com, akismet.com, simplenote.com, simperium.com, leandomainsearch.com, cloudup.com, longreads.com, and happy.tools);</li>
<li>Our mobile applications (including the WordPress mobile app for Android and iOS);</li>
<li>Our other Automattic products, services, and features that are available on or through our websites (for example, WordPress.com plans, Recurring Payments, Simple Payments, WordPress.com VIP, Jetpack, the WooCommerce Services Extension, Gravatar, the IntenseDebate comment management system, Akismet plans, Simplenote, Simperium, Cloudup, Longreads, and Happy Tools); and</li>
<li>Other users’ websites that use our Services, while you are logged in to your account with us.</li>
<li>Throughout this Privacy Policy we’ll refer to our websites, mobile applications, and other products and services collectively as “Services.” And if you’d like to learn more about which Automattic company is the controller of information about you, take a look at the section below on Controllers and Responsible Companies.</li>
</ul>

Below we explain how we collect, use, and share information about you, along with the choices that you have with respect to that information.

<h3 class="beta-title">Information We Collect</h3>
...
<h5 class="beta-title">Information You Provide to Us</h5>
...
<ul>
<li><span class="text-bold">Basic Account Information:</span> We ask for basic information from you in order to set up your account. For example, we require individuals who sign up for a WordPress.com account to provide an email address along with a username or name, depending on the service – and that’s it. You may provide us with more information – like your address and other information you want to share – but we don’t require that information to create a WordPress.com account.</li>
<li><span class="text-bold">Public Profile Information:</span> If you have an account with us, we collect the information that you provide for your public profile. For example, if you have a WordPress.com account, your username is part of that public profile, along with any other information you put into your public profile, such as a photo or an “About Me” description. Your public profile information is just that — public — so please keep that in mind when deciding what information you would like to include.</li>
<li><span class="text-bold">Billing and Contact Information:</span> If you buy something from us –a subscription to a WordPress.com plan, a premium theme, a custom domain, or some fun Longreads swag, for example – or pay fees to a site owner (for example via Recurring Payments or Simple Payments),  you will provide additional personal and payment information, such as your name, credit card information, and contact information.</li>
<li><span class="text-bold">Happy Tools Information:</span> If you are a Happy Tools user, you will provide us with information to make use of the Service’s features. For example, you might enter timezone and location information, company information, and contact information.</li>
<li><span class="text-bold">Ecommerce Site Information:</span> If you use our ecommerce Services to sell products or services to others through your site (including Stores on WordPress.com, the WooCommerce Services extension, or other purchases on WooCommerce.com), you will have to create a WordPress.com account or connect an existing account and, for some of our ecommerce Services, provide your site URL. You may also provide us with information about your financial account to set up a payments integration, such as the email address for your Stripe or PayPal account or your bank account information.</li>
<li><span class="text-bold">Content Information:</span> Depending on the Services you use, you may also provide us with information about you in draft and published content (such as for your website or your Crowdsignal survey). For example, if you write a blog post that includes biographic information about you, we will have that information, and so will anyone with access to the Internet if you choose to publish the post publicly. This might be obvious to you…but it’s not to everyone!</li>
<li><span class="text-bold">Credentials:</span> Depending on the Services you use, you may provide us with credentials for your website (like SSH, FTP, and SFTP username and password). For example, Jetpack and VaultPress users may provide us with these credentials in order to use our one-click restore feature if there is a problem with their site, or to allow us to troubleshoot problems on their site more quickly.</li>
<li><span class="text-bold">Communications with Us (Hi There!):</span> You may also provide us information when you respond to surveys, communicate with our Happiness Engineers about a support question, post a question about your site in our public forums, or sign up for a newsletter like the one we send through Longreads. When you communicate with us via form, email, phone, WordPress.com comment, or otherwise, we store a copy of our communications (including any call recordings as permitted by applicable law).</li>
</ul>
<h5 class="beta-title">Information We Collect Automatically</h5>
<p>We also collect some information automatically:</p>
<ul>
<li><span class="text-bold">Log Information:</span> Like most online service providers, we collect information that web browsers, mobile devices, and servers typically make available, such as the browser type, IP address, unique device identifiers, language preference, referring site, the date and time of access, operating system, and mobile network information. We collect log information when you use our Services–for example, when you create or make changes to your website on WordPress.com.</li>
<li><span class="text-bold">Usage Information:</span> We collect information about your usage of our Services. For example, we collect information about the actions that site administrators and users perform on a site using our WordPress.com or Jetpack services–in other words, who did what, when and to what thing on a site (e.g., [WordPress.com username] deleted “[title of post]” at [time/date]). As another example, our WooCommerce Usage Tracker tracks information like your email address, WooCommerce settings, PHP settings, and other features for your site, along with information about your online store, such as the aggregate number of orders and customers. We also collect information about what happens when you use our Services (e.g., page views, support document searches at en.support.wordpress.com, features enabled for your website, interactions with our Admin Bar and other parts of our Services) along with information about your device (e.g., screen size, name of cellular network, and mobile device manufacturer). We use this information to, for example, provide our Services to you, as well as get insights on how people use our Services, so we can make our Services better.</li>
<li><span class="text-bold">Location Information:</span> We may determine the approximate location of your device from your IP address. We collect and use this information to, for example, calculate how many people visit our Services from certain geographic regions. We may also collect information about your precise location via our mobile apps (when, for example, you post a photograph with location information) if you allow us to do so through your mobile device operating system’s permissions.</li>
<li><span class="text-bold">Stored Information:</span> We may access information stored on your mobile device via our mobile apps. We access this stored information through your device operating system’s permissions. For example, if you give us permission to access the photographs on your mobile device’s camera roll, our Services may access the photos stored on your device when you upload a really amazing photograph of the sunrise to your website.</li>
<li><span class="text-bold">Interactions with Other Users’ Sites:</span> We collect some information about your interactions with other users’ sites while you are logged in to your account with us, such as your “Likes” and the fact that you commented on a particular post, so that we can, for example, recommend posts we think may interest you. As another example, for Intense Debate users, we collect information about the comments you make while logged in to your account, and use that information to, for example, tally up statistics about your comments (check them out in your dashboard!) and provide the information about your comments in your Intense Debate public profile.</li>
<li><span class="text-bold">Information from Cookies & Other Technologies:</span> A cookie is a string of information that a website stores on a visitor’s computer, and that the visitor’s browser provides to the website each time the visitor returns. Pixel tags (also called web beacons) are small blocks of code placed on websites and emails. Automattic uses cookies and other technologies like pixel tags to help us identify and track visitors, usage, and access preferences for our Services, as well as track and understand email campaign effectiveness and to deliver targeted ads. For more information about our use of cookies and other technologies for tracking, including how you can control the use of cookies, please see our Cookie Policy.</li>
</ul>
<h5 class="beta-title">Information We Collect from Other Sources</h5>
<p>We may also get information about you from other sources. For example, if you create or log into your WordPress.com account through another service (like Google) or if you connect your website or account to a social media service (like Twitter) through our Publicize feature, we will receive information from that service (such as your username, basic profile information, and friends list) via the authorization procedures used by that service. The information we receive depends on which services you authorize and any options that are available.</p>
...
<h3 class="beta-title">How and Why We Use Information</h3>
...
<ul>
<li>To provide our Services–for example, to set up and maintain your account, host your website, backup and restore your website, charge you for any of our paid Services, or provide essays and stories for your reading pleasure through Longreads;</li>
...
<li>To measure, gauge, and improve the effectiveness of our advertising, and better understand user retention and attrition — for example, we may analyze how many individuals purchased a paid plan after receiving a marketing message or the features used by those who continue to use our Services after a certain length of time;</li>
...
<li>To communicate with you. For example, we may email you to solicit your feedback, share tips for getting the most out of our products, or keep you up to date on Automattic; text you to verify your payment; or call you to share offers and promotions that we think will be of interest to you. If you don’t want to hear from us, you can opt out of marketing communications at any time. (Please keep in mind that even if you opt out, we’ll still send you important updates relating to your account); and</li>
...
<h5 class="beta-title">Legal Bases for Collecting and Using Information</h5>
...
<ol>
<li>The use is necessary in order to fulfill our commitments to you under the applicable terms of service or other agreements with you or is necessary to administer your account — for example, in order to enable access to our website on your device or charge you for a paid plan; or</li>
